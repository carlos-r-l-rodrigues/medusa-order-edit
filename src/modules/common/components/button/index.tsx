...
const Button = ({
  ...
  return (
    <button
      {...props}
      className={clsx(
        "w-full flex items-center justify-center min-h-[50px] px-5 py-[10px] text-small-regular rounded-rounded border transition-colors duration-200 disabled:opacity-50",
        {
