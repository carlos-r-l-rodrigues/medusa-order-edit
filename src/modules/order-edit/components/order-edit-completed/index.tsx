    ...
    <div className="grid h-screen place-items-center">
      <div className="w-64 justify-items-center text-center">
...

        {
          ...
          <div>
            <h2 className="text-grey-40 text-base mb-2">Payment Successful</h2>
            ...
            <br />
            <span className="text-grey-40 text-base">The payment will appear on your statement as "Branded Store order edit”.</span>
          </div>
        }

        {
          (orderEdit.payment_collection == null && orderEditStatus === "confirmed") &&
          <div>
            <h2 className="text-grey-40 text-base mb-2">Payment Refunded</h2>
            {
        ...
        <div className="">
          {
            ...
            <div>
              <span className="text-grey-40 text-base">Order Edit was declined</span>
              <br />
              <span className="text-grey-40 text-base">"{orderEdit.declined_reason}"</span>
            </div>
          }
